...
Now it is very easy to get the equations, since vectors and matrices have their own mathematical operations. we can now write our euqation ofr the population at a certain time as:
...
If we apply the product between vectors and matrices as we learned in high school, we will see that:
