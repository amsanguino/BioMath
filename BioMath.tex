...
\begin{equation}
	\mathbf{x}= e^{a \, t} \,  \left( c_1  \, e^{ i \, b \, t} + c_2 \,  e^{-i \, b \, t}\right)
\end{equation}
...
As can be seen in the figure above, $- \sin{b \, t}=\sin{- b \, t}$ and $\cos{b \, t}=\cos{ - b \, t}$ so we can rearrange terms:
...
\begin{equation}
	x_1= e^{a \, t} \, \left(   \left( c_1+c_2\right) \,  \cos{ b \, t}  + i \,\left( c_1-c_2 \right) \,  \sin{ b \, t}  \right)
\end{equation}

So the real part of our solutions will be the product of an exponential having the real part of the eigenvalue and an oscillatory function based on its imaginary part. The stability of the system will therefore be deterined by the sign of $\operatorname{Re}(\lambda)$ and oscillations will appear when $\operatorname{Im}(\lambda) \neq 0$. 

% Include graph with damped oscillations, unstable oscillations, etc...
